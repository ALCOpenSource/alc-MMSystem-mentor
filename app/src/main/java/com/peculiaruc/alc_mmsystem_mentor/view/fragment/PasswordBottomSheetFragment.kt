...
class PasswordBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun setPopUpContent() {
        binding.tvPopUpTitle.text = getText(R.string.password_reset_successful)
        binding.tvPopUpMessage.visibility = View.GONE
        binding.ivPopUpImage.setImageResource(R.drawable.img_password_success)
        binding.btnDismiss.text = getText(R.string.login)
    }
}